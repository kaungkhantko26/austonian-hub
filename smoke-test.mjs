...
check(styles.includes('bottom:0!important') && styles.includes('height:calc(50px + env(safe-area-inset-bottom,0px))!important'), 'Mobile bottom navigation does not sit flush at the end of the safe area');
check(styles.includes('left:50%!important') && styles.includes('transform:translateX(-50%)!important'), 'Mobile bottom navigation is not horizontally centered');
